...
export const CreateRoom = async ({rname,sub,subcode,block,invName,time}) => {
    ...
    let client;
    try {
        const invPhoto =  fs.readFileSync('./images/wow.jpg');
...
export const UpdateRoomById = async ({rname,sub,subcode,block,invName,time,id}) => {
